// src/app/services/digital-asset/Content.tsx
"use client";
  ...
  return (
    ...
    >
      ...
      <div className="space-y-12 md:space-y-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-6 rounded-xl border border-red-900/30 bg-[#1a0505]/70 backdrop-blur-sm shadow-lg">
            ...
            <p className="text-text-muted mb-4">
              ...
              &quot;скормить&quot; нейросети старые регламенты и противоречивые
              переписки, вы получите{" "}
        ...
        {/* БЛОК 4: Стратегия */}
        <div className="bg-secondary-dark/70 backdrop-blur-sm p-8 rounded-2xl border border-white/5 shadow-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 bg-secondary-dark/70 backdrop-blur-sm p-8 rounded-2xl border border-white/10 shadow-lg">
          <div className="lg:col-span-2">
            ...
            <p className="text-text-muted text-lg">
              ...
              вашего бизнеса. Это актив, который работает на капитализацию вашей
              компании.
            </p>
          </div>
          <div>
