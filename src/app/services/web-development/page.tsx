        ...
        <div className="bg-secondary-dark/60 backdrop-blur-sm p-6 md:p-8 rounded-lg border border-white/10 shadow-lg">
          ...
          <div className="prose prose-invert lg:prose-lg max-w-none mx-auto">
            ...
            <ul>
              ...
              <li>
                Компаниям, нуждающимся в сложных веб-приложениях, личных
                кабинетах или интеграциях.
              </li>
              <li>
                Всем, кто ценит качество, современный дизайн и надежность.
              </li>
            </ul>
            ...
            <p>
              ...
              этого разрабатываем структуру, дизайн (если требуется) и
              функционал. Используя передовые технологии, такие как Next.js, мы
              обеспечиваем высокую производительность и отличный
              пользовательский опыт. Весь процесс разработки прозрачен, и вы
              всегда в курсе текущего статуса.
            </p>
