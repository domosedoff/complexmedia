...
export const trackedQueries = [
  ...
  "заказать голосового ии консультанта",
  "голосовой ии консультант для бизнеса",
  "телефонный ии консультант",
  "ии оператор по телефону",
  "автоматизация звонков с ии",
  "голосовой чат бот для бизнеса",
] as const;
